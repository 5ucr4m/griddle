...
const Logo = require("../../assets/imgs/griddle-logo.png");
const LogoOnboarding = require("../../assets/imgs/griddle-logo-onboarding.png");
const ProfileBackground = require("../../assets/imgs/profile-screen-bg.png");
const RegisterBackground = require("../../assets/imgs/register-bg.png");
const Pro = require("../../assets/imgs/getPro-bg.png");
const GriddleLogo = require("../../assets/imgs/griddle-color-logo.png");
const iOSLogo = require("../../assets/imgs/ios.png");
const androidLogo = require("../../assets/imgs/android.png");
const spinner = require("../../assets/imgs/spinner.gif");

// internet imgs

const ProfilePicture = "https://www.stevensegallery.com/640/360";
