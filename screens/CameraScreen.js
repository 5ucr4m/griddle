...
export default class CameraScreen extends React.Component {
  ...
  onPictureSaved = async photo => {
    ...
    if(this.props.navigation.getParam('profileScreen')){
      ...
      this.props.navigation.navigate('Profile', {base64:manipResult.base64, photoUri:photo.uri});
    } else {
      ...
      this.setState({showFeatured:true, photoURI: photo.uri, base64:manipResult.base64, token: this.props.navigation.getParam('token')});
  ...
  renderMoreOptions = () =>
    ...
    renderFeatured = () => {
      return  <Card
              ...
              full
              style={{position:'absolute', top: (height/2) - 250, left: 35, width: width-100 }}
              />
    }
