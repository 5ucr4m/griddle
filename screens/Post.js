...
class Post extends React.Component {
  ...
  renderCards = () => {
    if (
      ...
      return (
        <SafeAreaView>
          <Block flex style={(styles.group, { paddingTop: 10 })}>
            <Block flex>
              <Block style={{ paddingHorizontal: theme.SIZES.BASE + 49 }}>
                <Block flex card shadow style={styles.category}>
                  <ImageBackground
                    source={{
                      uri:
                        articles[this.props.navigation.getParam("item").id]
                          .image
                    }}
                    style={[
                      styles.imageBlock,
                      { width: 144 * 1.6, height: 256 * 1.6 }
                    ]}
                    imageStyle={{
                      width: 144 * 1.6,
                      height: 256 * 1.6
