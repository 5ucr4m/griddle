...
import { Animated, TouchableHighlight, View, Dimensions } from 'react-native';
...
export default class Lightbox extends Component {
  ...
  state = {
    ...
    origin: {
      x: 0,
      y: 130,
      width: this.props.width ? this.props.width : 174.6 * 1.055,
      height: this.props.height ? this.props.height : 224.6 * 1.055,
      paddingTop:0
    },
  ...
  render() {
    return (
      ...
      >
        ...
        {this.props.navigator ? false : <LightboxOverlay {...this.getOverlayProps()} onContentTouch={this.props.onContentTouch} />}
      </View>
    );
  }
}