  ...
  render() {
    ...
    const background = (
      <TouchableOpacity onPress={this.close}>
        <Animated.View style={[styles.background, { backgroundColor: backgroundColor }, lightboxOpacityStyle]}></Animated.View>
      </TouchableOpacity>
      );
    ...
    const content2 = (<Animated.View style={[openStyle, dragStyle]} {...handlers}>{(renderHeader ?
      renderHeader(this.close, this.closeNow) :
      (
        <TouchableOpacity onPress={this.close} style={[openStyle, dragStyle],{flex:1,  padding:0, marginTop:0, backgroundColor:'transparent'}}>
